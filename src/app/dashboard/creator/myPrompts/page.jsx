...
export default async function CreatorAllPromptsPage() {
                                        ...
                                        <Table.Cell>
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <Tooltip content="Update Prompt">
                                                    <Link
                                                        href={`/dashboard/creator/myPrompt/update/${prompt._id}`}
                                                ...
                                                <Tooltip content="View Analytics">
                                                    <Link
                                                        href={`/dashboard/creator/myPrompt/analytics/${prompt._id}`}
